      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-6 ml-8">
              <button className="px-4 py-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-full text-sm transition-colors">Features</button>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full space-y-6 text-lg">
              ...
              <button className="px-6 py-3 bg-gray-800/50 rounded-full">Features</button>
        ...
        >
          <motion.div variants={itemVariants}>
            <FeatureItem name="AI Clipping" value="Instant clips" position="left-0 sm:left-10 top-40" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Multi-Platform" value="5+ networks" position="left-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Analytics" value="Real-time data" position="right-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Auto-Post" value="Schedule once" position="right-0 sm:right-10 top-40" />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl md:text-5xl pb-3 font-light bg-gradient-to-r from-gray-100 via-purple-200 to-gray-300 bg-clip-text text-transparent"
          >
